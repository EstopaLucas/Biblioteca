...
class Estudiantes extends Controller
{
    ...
    public function registrar()
    {
        ...
        if (empty($codigo) || empty($dni) || empty($nombre) || empty($carrera)) {
            $msg = array('msg' => 'Todos os dados são obrigatórios', 'icono' => 'warning');
        } else {
            if ($id == "") {
                    ...
                    if ($data == "ok") {
                        ...
                        $msg = array('msg' => 'Estudante ja existe', 'icono' => 'warning');
                    } else {
    ...
    public function eliminar($id)
    {
        ...
        if ($data == 1) {
            $msg = array('msg' => 'Estudante excluido', 'icono' => 'success');
        } else {
